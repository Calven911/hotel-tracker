 ...
 */
const hotels = [
    { name: "Boracay Beach Resort", loc: "Boracay, Aklan", price: 4500, cat: "beach", img: "boracay.jpg", subImgs: ["Boracay Beach Resort(1).jpg", "Boracay Beach Resort(2).jpg"], rate: 5, desc: "A stunning beachfront escape offering crystal clear waters and white sand." },
    { name: "The Manila Hotel", loc: "One Rizal Park, Manila", price: 3200, cat: "city", img: "manila.jpg", subImgs: ["Manila City Hotel.jpg", "Manila City Hotel (2).jpg"], rate: 5, desc: "Overlooking the South Harbor, this iconic luxury hotel is a refined sanctuary." },
    { name: "Baguio Mountain Lodge", loc: "Baguio City", price: 5800, cat: "mountain", img: "baguio.jpg", subImgs: ["Baguio Mountain(1).jpg", "Baguio Mountain Lodge(2).jpg"], rate: 4, desc: "Nestled in the cold mountains of Baguio with a cozy stone fireplace." },
    { name: "Cebu Bay Hotel", loc: "Cebu City", price: 3800, cat: "city", img: "cebu.jpg", subImgs: ["Cebu Bay Hotel(1).jpg", "Cebu Bay Hotel(2).jpg"], rate: 4, desc: "Featuring a stunning rooftop infinity pool overlooking the city skyline." },
    { name: "El Nido Island Resort", loc: "Palawan", price: 7200, cat: "beach", img: "El Nido Island Resort.jpg", subImgs: ["El Nido Island Resort(2).jpg", "El Nido Island Resort (3).jpg"], rate: 5, desc: "A paradise tucked away in limestone cliffs with private villas." },
    { name: "Davao Downtown Inn", loc: "Davao City", price: 2300, cat: "city", img: "Davao Downtown Inn.jpg", subImgs: ["Davao Downtown Inn - Hop Inn Hotel Davao(1).jpg", "Davao Downtown Inn - Hop Inn Hotel Davao(2).jpg"], rate: 3, desc: "Modern, clean, and perfect for business travelers in downtown Davao." }
];
...
function searchByDest(dest) {
    ...
    displayHotels(hotels.filter(h => h.loc.toLowerCase().includes(dest.toLowerCase())));
}
